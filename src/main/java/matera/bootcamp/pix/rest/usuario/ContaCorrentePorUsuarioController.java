...
public class ContaCorrentePorUsuarioController {
    ...
    public ResponseEntity<ContaCorrente> buscarPorUsuario(@PathVariable Long id) {
        ...
        var contaConsultada = consultaContaUsuarioService.consultarContaPorUsuarioId(id);

        return ResponseEntity.status(HttpStatus.OK).body(contaConsultada);
    }
}